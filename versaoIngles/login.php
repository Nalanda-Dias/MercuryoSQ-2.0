        ...
        <div class="signin-signup">
          <form action="validausuario.php" method="post" name="login"  class="sign-in-form">
            ...
            <div class="row">
              <button type="submit" id="oi" class="btn solid">
                <a id="voltar" href="index.php">Return</a>
              </button>
              <input type="submit" name="enviar" id="enviar" value="Enter" class="btn btn-primary btn-lg btn-block">
            </div>
          </form>
          <form action="cadastrausuario.php" method="post" enctype="multipart/form-data"  class="sign-up-form">
            ...
            <div class="input-field">
             ...
             <div class="input-field">
              <i class="fas fa-user"></i>
              <input type="text" name="txtnome" placeholder="Name" required />
            </div>
            <div class="input-field">
              <i class="fas fa-user"></i>
              <input type="text" name="txtusuario" placeholder="User" required />
            </div>
            <div class="input-field">
              <i class="fas fa-lock"></i>
              <input type="password" name="senha" id="idsenha" placeholder="Password" required />
            </div>
           <div class="row">
              <button type="submit" id="oi" class="btn solid">
                <a id="voltar" href="index.php">Return</a>
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>New here ?</h3>
            <p>
              Register on our website and make a quote with us!!!
            </p>
